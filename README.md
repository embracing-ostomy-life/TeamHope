...
| [whitenoise](https://pypi.org/project/whitenoise/) | Static file serving for WSGI applications, used in the deployed app. <br><br> This package is used in the [embracing_ostomy_life/production.py](./embracing_ostomy_life/production.py) file, which configures production settings. |

...
class EthnicityChoices(models.TextChoices):
    ...
    AMERICAN_INDIAN_OR_ALASKA_NATIVE = 'American Indian or Alaska Native', _('American Indian or Alaska Native')
    ASIAN = 'Asian', _('Asian')
    BLACK_OR_AFRICAN_AMERICAN = 'Black or African American', _('Black or African American')
    NATIVE_HAWAIIAN_OR_OTHER_PACIFIC_ISLANDER = 'Native Hawaiian or Other Pacific Islander', _('Native Hawaiian or Other Pacific Islander')
    WHITE = 'White', _('White')
    OTHER = 'Other', _('Other')
...
class UserProfile(models.Model):
    ...
    surgery_type = models.CharField(max_length=50, null=True, blank=True)  # Ensure this is present
